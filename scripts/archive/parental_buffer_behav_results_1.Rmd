...
#qq plots for inspecting residuals' distribution
  qqnorm(DBehav_Wide$Parent_Pre_PlusMinMinus)
  qqnorm(DBehav_Wide$Parent_Post_PlusMinMinus)
  qqnorm(DBehav_Wide$Alone_Pre_PlusMinMinus)
  qqnorm(DBehav_Wide$Alone_Post_PlusMinMinus)
...
#qq plots for inspecting residuals' distribution
  qqnorm(DBehav_Wide$Parent_Pre_PlusMinMinus.ner)
  qqnorm(DBehav_Wide$Parent_Post_PlusMinMinus.ner)
  qqnorm(DBehav_Wide$Alone_Pre_PlusMinMinus.ner)
  qqnorm(DBehav_Wide$Alone_Post_PlusMinMinus.ner)
  
#Greenhouse-Geisser sphericity correction is automatically applied to factors violating the sphericity assumption (https://www.datanovia.com/en/lessons/repeated-measures-anova-in-r/)
  
#perform the test
  NervousRESP_anovatest <- anova_test(data = DBehav_Longdif, dv = NervousRESP, wid = Subject,within = c(version, time), type=3)
  get_anova_table(NervousRESP_anovatest)
  
#investigate the main effect of time - CONTINUE HERE
