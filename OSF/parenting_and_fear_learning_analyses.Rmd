...
#multilevel linear regression - DECIDE IF REMOVE FROM FINAL OSF!!
...
#find means for time regardless of parental context condition (since there is no interaction effect)
#a) summarize overall group effects by condition
...
#analysis controlling for sex and age
  lmer_amyg_noise_baseline_sex_age <- lmer(data=DROI_amyg, amyg_activation.noise_baseline~
                                             Parent_Alone_num_c*SEX_num_c +
                                             Parent_Alone_num_c*MRI_AGE_c +(1|Subject))
...
#analysis controlling for sex and age
  lmer_amyg_plus_minus_sex_age <- lmer(data=DROI_amyg, amyg_activation.plus_minus~
                                             Parent_Alone_num_c*SEX_num_c +
                                             Parent_Alone_num_c*MRI_AGE_c + (1|Subject))
