...
do 
	...
	cp XXX/06_level1/ident.mat ./reg/example_func2standard.mat;
...
chmod 775 XXX/derivatives/05_level1/smoothed_fin_contrasts_skulstrip/sub-*/task-*.feat/reg/standard.nii.gz;
chmod 775 XXX/derivatives/05_level1/smoothed_fin_contrasts_skulstrip/sub-*/task-*.feat/reg/example_*;
